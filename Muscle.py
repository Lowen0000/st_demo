...
if df.empty:
    ...
    with tab4:
        ...
        st.markdown("輸入你的 InBody 各部位肌肉量 (kg)，系統將結合你**這個月**的訓練量，自動抓出受傷風險與失衡點。")
        ...
        with col_pattern:
            ...
            if 'Movement_Pattern' in this_month_df.columns and not this_month_df.empty:
                ...
                st.info("本月尚無「動作模式」分類的數據，請從側邊欄新增紀錄！")
